...
class Unit extends BaseModel
{
    ...
    {
        return $this->belongsTo(BaseUnit::class , 'base_unit', 'id');
    }
    ...
    public function prepareAttributes(): array
    {
        $fields = [
            ...
            'base_unit_name' => $this->relationLoaded('baseUnit') ? ($this->baseUnit ? $this->baseUnit->toArray() : '') : $this->getBaseUnitName(),
        ];
    ...
    {
        $productUnit = $this->relationLoaded('baseUnit') ? $this->baseUnit : BaseUnit::whereId($this->base_unit)->first();
        if ($productUnit) {
