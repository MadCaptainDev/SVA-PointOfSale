...
class HsnSalesReportExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize, WithEvents
{
    protected $data;
    ...
    {
        return [
            ["HSN Sales Report – From {$this->startDate} to {$this->endDate}"],
            [
                'S.No',
                'HSN Code',
                'Product Name',
