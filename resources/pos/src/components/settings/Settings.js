...
const Settings = (props) => {
            ...
            setSettingValue({
                ...
                Currency_icon_Right_side:
                    settings.attributes &&
                        ...
                        : true,
                point_earning_rate:
                    settings.attributes && settings.attributes.point_earning_rate
                        ? settings.attributes.point_earning_rate
                        : "",
                point_redemption_rate:
    ...
    const handleValidation = () => {
        ...
        } else if (!settingValue["point_earning_rate"]) {
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 mb-3">
                                    <label className="form-label">
                                        Point Earning Rate (1 Point = X Amount):
                                    </label>
                                    <input
                                        type="text"
                                        name="point_earning_rate"
                                        className="form-control"
                                        placeholder="Enter point earning rate"
                                        onChange={(e) => onChangeInput(e)}
                                        value={settingValue.point_earning_rate}
                                    />
                                    {errors["point_earning_rate"] ? (
                                ...
                                <div className="col-lg-6 mb-3">
                                    <label className="form-label">
                                        Point Redemption Rate (1 Point = X Amount):
                                    </label>
                                    <input
                                        type="text"
                                        name="point_redemption_rate"
                                        className="form-control"
                                        placeholder="Enter point redemption rate"
                                        onChange={(e) => onChangeInput(e)}
                                        value={settingValue.point_redemption_rate}
                                    />
