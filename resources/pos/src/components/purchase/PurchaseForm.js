...
const PurchaseForm = ( props ) => {
  ...
  useEffect(() => {
    const warehouseId = purchaseValue.warehouse_id?.value || purchaseValue.warehouse_id;
    if (warehouseId) {
        fetchAllProducts();
    }
...
{purchaseValue.warehouse_id && products.length === 0 && (
    <div className='col-md-12 mb-3'>
                        ...
                        <Table responsive>
                            ...
                            <tbody>
                                {updateProducts && updateProducts.map( ( singleProduct, index ) => {
                                 console.log('Unit Cost:', singleProduct.net_unit_cost);
                                  console.log('Unit Cost:', singleProduct);
