...
use App\Http\Controllers\API\CustomerWithdrawalAPIController;
...
Route::middleware('auth:sanctum')->group(function () {
    Route::middleware('permission:manage_brands')->group(function () {
        ...
        // customer withdrawals route
        Route::middleware('permission:manage_customers')->group(function () {
            Route::resource('customer-withdrawals', CustomerWithdrawalAPIController::class);
        }
        );
